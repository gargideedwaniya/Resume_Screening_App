📄 Resume Screening App A simple and interactive Streamlit web application that classifies uploaded resumes (PDF, DOCX, TXT) into job categories using Machine Learning.
